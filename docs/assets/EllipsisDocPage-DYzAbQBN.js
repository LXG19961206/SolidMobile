import{u as r,bF as m,c as n,i as l,P as x,F as h,t as u,r as E,bG as b,bH as g}from"./index-CMUIHquS.js";import{D as f}from"./ComponentDocLayout-CTIAxjRF.js";import{D}from"./DocLayout-Cw9mKrhd.js";var C=u('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Ellipsis</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');E({"zh-CN":g,"en-US":b});const y=()=>{const e=r(),{propsTables:i,cssVarsTables:o}=m(),a=[{title:e("ellipsis.demo.basic"),code:"<Ellipsis>Long text that needs to be truncated...</Ellipsis>",desc:e("ellipsis.demoDesc.basic")},{title:e("ellipsis.demo.multi"),code:`<Ellipsis lines={3}>
...
>
  {longText}
</Ellipsis>`,desc:e("ellipsis.demoDesc.controlled")}];return n(D,{get children(){var s=C(),p=s.firstChild,t=p.nextSibling,d=t.nextSibling;return l(t,()=>e("ellipsis.intro")),l(s,n(x,{propsTables:i,cssVarsTables:o}),d),l(s,n(h,{each:a,children:c=>n(f,{demo:c})}),null),s}})};export{y as EllipsisDocPage};
