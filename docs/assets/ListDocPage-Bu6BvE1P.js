import{u as d,au as c,c as i,i as s,P as p,F as h,t as f,r as L,av as g,aw as x}from"./index-Cwbnksd1.js";import{D as u}from"./ComponentDocLayout-Dtxrt-rT.js";import{D as v}from"./DocLayout-Ce9trnrr.js";var D=f('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">List</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');L({"zh-CN":x,"en-US":g});const b=()=>{const e=d(),{propsTables:a}=c(),o=[{title:e("list.demo.static"),code:`<List data={items}>
  {(item) => (
