import{m as b,aF as m,c as t,r as v,aG as p,aH as g,i as s,P as f,F as h,D as x,a as N,t as B}from"./index-DvnxeU6a.js";var D=B('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">NavBar</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');v({"zh-CN":g,"en-US":p});const k=()=>{const e=b(),{propsTables:r,cssVarsTables:i}=m(),o=[{title:e("navbar.demo.basic"),code:'<NavBar title="Page Title" border />',desc:e("navbar.demoDesc.basic")},{title:e("navbar.demo.back"),code:'<NavBar title="Details" backArrow onBack={() => history.back()} />',desc:e("navbar.demoDesc.back")},{title:e("navbar.demo.sides"),code:`<NavBar
  title="Messages"
...
/>`,desc:e("navbar.demoDesc.sides")},{title:e("navbar.demo.style"),code:'<NavBar title="Brand" background="#1677ff" color="#fff" backArrow />',desc:e("navbar.demoDesc.style")},{title:e("navbar.demo.fixed"),code:'<NavBar title="Fixed Nav" fixed placeholder border />',desc:e("navbar.demoDesc.fixed")},{title:"JSX Title + Tabs",code:`<NavBar
  ...
  right={<span>+ New</span>}
/>`,desc:"title 支持任意 JSX，可嵌入 Tabs 等组件，实现导航栏 + 标签页的复合布局。"}];return t(N,{get children(){var a=D(),l=a.firstChild,n=l.nextSibling,c=n.nextSibling;return s(n,()=>e("navbar.intro")),s(a,t(f,{propsTables:r,cssVarsTables:i}),c),s(a,t(h,{each:o,children:d=>t(x,{demo:d})}),null),a}})};export{k as NavBarDocPage};
