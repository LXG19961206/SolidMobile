import{u as c,w as l,c as n,i as a,P as m,F as p,t as B,r as b,x as h,y as u}from"./index-DbmUbd2J.js";import{D as x}from"./ComponentDocLayout-D8jJ0usU.js";import{D}from"./DocLayout-D3lR4DT8.js";var w=B('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Badge</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');b({"zh-CN":u,"en-US":h});const z=()=>{const e=c(),{propsTables:d}=l(),s=[{title:e("badge.demo.withAvatar"),code:`<Badge content={5}>
  <Avatar size={40} />
</Badge>
<Badge dot>
  <Avatar size={40} />
...
<span>Done <Badge content="✓" color="#22c55e" /></span>`,desc:e("badge.demoDesc.standalone")}];return n(D,{get children(){var t=w(),i=t.firstChild,o=i.nextSibling,g=o.nextSibling;return a(o,()=>e("badge.intro")),a(t,n(m,{propsTables:d}),g),a(t,n(p,{each:s,children:r=>n(x,{demo:r})}),null),t}})};export{z as BadgeDocPage};
