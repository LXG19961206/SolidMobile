import{m,bu as b,c as n,r as d,bv as f,bw as h,i as t,P as p,F as u,D as g,bx as B,a as T,t as I}from"./index-DvnxeU6a.js";var k=I('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">TabBar</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');d({"zh-CN":h,"en-US":f});const P=()=>{const e=m(),{propsTables:r}=b(),s=[{title:e("tabbar.demo.basic"),code:`<TabBar defaultValue="home">
...
<TabBar defaultValue="a">
  ...
  <TabBarItem name="c" icon="user" label="Profile" />
</TabBar>`,desc:e("tabbar.demoDesc.fixed")}];return n(T,{get children(){var a=k(),i=a.firstChild,o=i.nextSibling,l=o.nextSibling;return t(o,()=>e("tabbar.intro")),t(a,n(p,{propsTables:r}),l),t(a,n(u,{each:s,children:c=>n(g,{demo:c})}),null),t(a,n(B,{}),null),a}})};export{P as TabBarDocPage};
