...
<ChatMessage position="right" messageType="plainText"
  ...
  status="failed" onRetry={() => retry()} />`,desc:s("chatMessage.demoDesc.statusesAndMeta")}];return e(C,{get children(){var n=w(),m=n.firstChild,r=m.nextSibling,l=r.nextSibling,c=l.nextSibling,a=c.nextSibling;return t(r,()=>s("chatMessage.intro")),t(n,e(u,{propsTables:p}),l),t(a,e(i,{position:"left",messageType:"plainText",bgColor:"#dbeafe",get content(){return s("chatMessage.demoDesc.basic")?.toString()||"Hey! How are you doing?"},avatar:o,name:"Alice",time:"10:32"}),null),t(a,e(i,{position:"right",messageType:"plainText",content:"I'm good! Just finished the new chat UI component 🎉",time:"10:33",status:"read"}),null),t(a,e(i,{position:"left",messageType:"image",bgColor:"#dbeafe",src:A,name:"Bob",time:"11:05",avatar:o}),null),t(a,e(i,{position:"right",messageType:"plainText",content:"Nice photo! 📷",time:"11:06",status:"read"}),null),t(a,e(i,{position:"left",messageType:"file",bgColor:"#dbeafe",iconMap:{pdf:"📄",doc:"📝",image:"🖼️","*":"📎"},get file(){return new File(["x".repeat(25e5)],"design-spec.pdf",{type:"application/pdf"})},name:"Alice",time:"11:20",avatar:o}),null),t(a,e(i,{position:"right",messageType:"custom",time:"11:22",status:"read",get children(){return v()}}),null),t(a,e(i,{position:"right",messageType:"plainText",content:"Sending...",time:"11:25",status:"sending"}),null),t(a,e(i,{position:"right",messageType:"plainText",content:"Message sent ✓",time:"11:26",status:"sent"}),null),t(a,e(i,{position:"right",messageType:"plainText",content:"Message read ✓✓",time:"11:30",status:"read"}),null),t(a,e(i,{position:"right",messageType:"plainText",content:"This one failed to send",time:"11:32",status:"failed",onRetry:()=>alert("Retry!")}),null),t(n,()=>d.map(h=>e(M,{demo:h})),null),n}})};export{_ as ChatMessageDocPage};
