import{u as d,bP as x,c as t,i as o,P as p,F as u,t as h,r as b,bQ as g,bR as T}from"./index-CED7t9D_.js";import{D as v}from"./ComponentDocLayout-C1KUKevd.js";import{D as f}from"./DocLayout-BEv_9ixD.js";var w=h('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Textarea</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');b({"zh-CN":T,"en-US":g});const z=()=>{const e=d(),{propsTables:s,cssVarsTables:l}=x(),n=[{title:e("textarea.demo.basic"),code:`<Textarea placeholder="Enter text" />
