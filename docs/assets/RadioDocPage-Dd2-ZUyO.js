import{u,b5 as m,c as o,i as l,P as p,F as v,t as b,r as h,b6 as R,b7 as g}from"./index-DONPGFCP.js";import{D as C}from"./ComponentDocLayout-DUBMc7rl.js";import{D as x}from"./DocLayout-Opy-arK6.js";var G=b('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Radio</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');h({"zh-CN":g,"en-US":R});const y=()=>{const e=u(),{propsTables:n,cssVarsTables:d}=m(),r=[{title:e("radio.demo.basic"),code:`const [val, setVal] = createSignal('a');
