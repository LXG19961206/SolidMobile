import{f as g,c as t,i,F as h,t as p,r as f}from"./index-CjqJoD8k.js";import{D as b}from"./ComponentDocLayout-7lKpA80h.js";import{u as w,e as x,z as T}from"./tableData-rXxiIjhY.js";import{P as u}from"./PropsAttrs-BEGKasrA.js";import{D as v}from"./DocLayout-BMuVmMAz.js";var S=p('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Switch</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><p style="padding:8px 12px;background:#fef3c7;border-radius:6px;font-size:0.85rem;color:#92400e"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');f({"zh-CN":T,"en-US":x});const k=()=>{const e=g(),{propsTables:n,cssVarsTables:l}=w(),a=[{title:e("switch.demo.basic"),code:`// ⚠ Import with alias to avoid SolidJS built-in <Switch>
...
</Form>`,desc:e("switch.demoDesc.form")}];return t(v,{get children(){var o=S(),r=o.firstChild,s=r.nextSibling,c=s.nextSibling,d=c.nextSibling;return i(s,()=>e("switch.intro")),i(c,()=>e("switch.note")),i(o,t(u,{propsTables:n,cssVarsTables:l}),d),i(o,t(h,{each:a,children:m=>t(b,{demo:m})}),null),o}})};export{k as SwitchDocPage};
