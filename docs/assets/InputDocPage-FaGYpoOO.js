import{u as c,al as d,c as t,i as n,P as m,F as h,t as C,r as v,am as g,an as b}from"./index-Bx4eLSXE.js";import{D as I}from"./ComponentDocLayout-cxqs5xhg.js";import{D as f}from"./DocLayout-a88CQXFm.js";var x=C('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Input</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');v({"zh-CN":b,"en-US":g});const z=()=>{const e=c(),{propsTables:o,cssVarsTables:r}=d(),s=[{title:e("input.demo.standalone"),code:`const [val, setVal] = createSignal('');
