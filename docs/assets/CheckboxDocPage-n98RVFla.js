import{u as d,N as r,c as l,i as a,P as x,F as k,t as u,r as C,O as m,Q as v}from"./index-Dj38xTE-.js";import{D as p}from"./ComponentDocLayout-BugiB5CJ.js";import{D as g}from"./DocLayout-6VL-aBST.js";var G=u('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Checkbox</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');C({"zh-CN":v,"en-US":m});const S=()=>{const e=d(),{propsTables:n,cssVarsTables:s}=r(),t=[{title:e("checkbox.demo.basic"),code:`const [vals, setVals] = createSignal<unknown[]>([]);
