...
>
  {longText}
</Ellipsis>`,desc:e("ellipsis.demoDesc.controlled")}];return n(f,{get children(){var s=C(),p=s.firstChild,t=p.nextSibling,d=t.nextSibling;return l(t,()=>e("ellipsis.intro")),l(s,n(u,{propsTables:i,cssVarsTables:a}),d),l(s,n(g,{each:o,children:c=>n(b,{demo:c})}),null),s}})};export{v as EllipsisDocPage};
