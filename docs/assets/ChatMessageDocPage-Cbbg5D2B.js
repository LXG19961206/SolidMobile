import{u as d,K as p,c as s,i as a,P as m,F as h,t as u,r as f,L as M,M as b}from"./index-DF6mUj0i.js";import{D as C}from"./ComponentDocLayout-7IjAfTG2.js";import{D as x}from"./DocLayout-D5vlqcEW.js";var y=u('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">ChatMessage</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');f({"zh-CN":b,"en-US":M});const A=()=>{const e=d(),{propsTables:n,cssVarsTables:o}=p(),l=[{title:e("chatMessage.demo.basic"),code:`<ChatMessage position="left" messageType="plainText"
...
/>`,desc:"Custom JSX mode: full control over menu layout. Still uses Tooltip for positioning."},{title:e("chatMessage.demo.longPressSelect"),code:`<ChatMessage position="left" messageType="plainText"
  ...
  selectOnLongPress
/>`,desc:"selectOnLongPress selects all bubble text on hold. Mutually exclusive with longPressMenu."}];return s(x,{get children(){var t=y(),c=t.firstChild,i=c.nextSibling,g=i.nextSibling;return a(i,()=>e("chatMessage.intro")),a(t,s(m,{propsTables:n,cssVarsTables:o}),g),a(t,s(h,{each:l,children:r=>s(C,{demo:r})}),null),t}})};export{A as ChatMessageDocPage};
