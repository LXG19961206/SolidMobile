import{u as c,k as l,c as n,i as a,P as m,F as p,t as B,r as b,l as h,m as u}from"./index-C5q_cPkQ.js";import{D}from"./ComponentDocLayout-ZFwLqY3y.js";import{D as x}from"./DocLayout-Dr6FrZTL.js";var f=B('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Badge</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');b({"zh-CN":u,"en-US":h});const z=()=>{const e=c(),{propsTables:d}=l(),s=[{title:e("badge.demo.withAvatar"),code:`<Badge content={5}>
  <Avatar size={40} />
</Badge>
<Badge dot>
  <Avatar size={40} />
