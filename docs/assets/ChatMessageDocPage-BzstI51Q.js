...
<ChatMessage position="right" messageType="plainText"
  ...
  status="failed" onRetry={() => retry()} />`,desc:i("chatMessage.demoDesc.statusesAndMeta")}];return e(C,{get children(){var n=w(),d=n.firstChild,r=d.nextSibling,l=r.nextSibling,c=l.nextSibling,s=c.nextSibling;return t(r,()=>i("chatMessage.intro")),t(n,e(u,{propsTables:m}),l),t(s,e(a,{position:"left",messageType:"plainText",bgColor:"#dbeafe",get content(){return i("chatMessage.demoDesc.basic")?.toString()||"Hey! How are you doing?"},avatar:o,name:"Alice",time:"10:32"}),null),t(s,e(a,{position:"right",messageType:"plainText",content:"I'm good! Just finished the new chat UI component 🎉",time:"10:33",status:"read"}),null),t(s,e(a,{position:"left",messageType:"image",bgColor:"#dbeafe",src:S,name:"Bob",time:"11:05",avatar:o}),null),t(s,e(a,{position:"right",messageType:"plainText",content:"Nice photo! 📷",time:"11:06",status:"read"}),null),t(s,e(a,{position:"left",messageType:"file",bgColor:"#dbeafe",fileName:"design-spec.pdf",fileSize:"2.4 MB",name:"Alice",time:"11:20",avatar:o}),null),t(s,e(a,{position:"right",messageType:"file",fileName:"report.xlsx",fileSize:"1.8 MB",progress:65,src:"https://example.com/report.xlsx",time:"11:21",status:"sending"}),null),t(s,e(a,{position:"right",messageType:"custom",time:"11:22",status:"read",get children(){return v()}}),null),t(s,e(a,{position:"right",messageType:"plainText",content:"Sending...",time:"11:25",status:"sending"}),null),t(s,e(a,{position:"right",messageType:"plainText",content:"Message sent ✓",time:"11:26",status:"sent"}),null),t(s,e(a,{position:"right",messageType:"plainText",content:"Message read ✓✓",time:"11:30",status:"read"}),null),t(s,e(a,{position:"right",messageType:"plainText",content:"This one failed to send",time:"11:32",status:"failed",onRetry:()=>alert("Retry!")}),null),t(n,()=>p.map(h=>e(M,{demo:h})),null),n}})};export{_ as ChatMessageDocPage};
