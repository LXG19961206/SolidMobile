import{u as m,bB as b,c as n,i as t,P as d,F as h,bC as f,t as p,r as T,bD as u,bE as B}from"./index-D49Qi2f8.js";import{D as g}from"./ComponentDocLayout-CsBFj3hR.js";import{D as k}from"./DocLayout-B5wmVzYP.js";var v=p('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">TabBar</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');T({"zh-CN":B,"en-US":u});const y=()=>{const e=m(),{propsTables:r}=b(),s=[{title:e("tabbar.demo.basic"),code:`<TabBar defaultValue="home">
...
function seg(len:number, anim:string, active:boolean) {
  ...
  /* inline values match keyframe from-state → no flash frame */
...
<TabBar defaultValue="a">
  ...
  <TabBarItem name="c" icon="user" label="Profile" />
</TabBar>`,desc:e("tabbar.demoDesc.fixed")}];return n(k,{get children(){var a=v(),i=a.firstChild,o=i.nextSibling,l=o.nextSibling;return t(o,()=>e("tabbar.intro")),t(a,n(d,{propsTables:r}),l),t(a,n(h,{each:s,children:c=>n(g,{demo:c})}),null),t(a,n(f,{}),null),a}})};export{y as TabBarDocPage};
