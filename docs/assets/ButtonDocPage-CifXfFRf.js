import{u as m,n as d,c as e,i as n,P as B,F as p,t as b,r as g,o as h,p as y}from"./index-CoRRO7P5.js";import{D as x}from"./ComponentDocLayout-CPPoOtGM.js";import{D}from"./DocLayout-C2Pfewh6.js";var z=b('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Button</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');g({"zh-CN":y,"en-US":h});const _=()=>{const t=m(),{propsTables:i,cssVarsTables:u}=d(),r=[{title:t("button.demo.types"),code:`<Button type="primary">Primary</Button>
