import{u as m,bU as d,c as e,i as n,P as u,F as T,t as g,r as B,bV as h,bW as b}from"./index-C9u4wmDu.js";import{D}from"./ComponentDocLayout-tkI-GR2P.js";import{D as f}from"./DocLayout-BFPGsvJi.js";var x=g('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Tooltip</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');B({"zh-CN":b,"en-US":h});const v=()=>{const t=m(),{propsTables:i,cssVarsTables:p}=d(),s=[{title:t("tooltip.demo.basic"),code:`<Tooltip content="Hello! This is a tooltip.">
