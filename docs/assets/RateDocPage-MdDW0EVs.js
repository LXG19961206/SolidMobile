import{u as m,bi as p,c as a,i as o,P as u,F as v,t as b,r as g,bj as h,bk as f}from"./index-CMUIHquS.js";import{D}from"./ComponentDocLayout-CTIAxjRF.js";import{D as x}from"./DocLayout-Cw9mKrhd.js";var R=b('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Rate</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');g({"zh-CN":f,"en-US":h});const F=()=>{const e=m(),{propsTables:l,cssVarsTables:s}=p(),n=[{title:e("rate.demo.basic"),code:`const [val, setVal] = createSignal(3);
