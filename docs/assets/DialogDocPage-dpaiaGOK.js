import{u as m,V as g,c as n,i,P as p,F as f,t as u,r as y,W as D,X as x}from"./index-C9u4wmDu.js";import{D as h}from"./ComponentDocLayout-tkI-GR2P.js";import{D as C}from"./DocLayout-BFPGsvJi.js";var v=u('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Dialog</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');y({"zh-CN":x,"en-US":D});const w=()=>{const e=m(),{propsTables:s,cssVarsTables:a}=g(),l=[{title:e("dialog.demoAlert"),code:`Dialog.alert({
  title: "Notice",
