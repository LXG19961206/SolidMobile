import{m,aO as u,c as l,r as v,aP as C,aQ as k,i as t,P as b,F as h,D as x,a as w,t as f}from"./index-DvnxeU6a.js";var g=f('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Picker</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');v({"zh-CN":k,"en-US":C});const D=()=>{const e=m(),{propsTables:i,optionTables:a,cssVarsTables:s}=u(),c=[{title:e("picker.demo.city"),code:`const [open, setOpen] = createSignal("");
...
<Picker
  ...
  swipeDuration={2}
  columns={timeCols}
/>`,desc:e("picker.inertiaDesc")}];return l(w,{get children(){var n=g(),r=n.firstChild,o=r.nextSibling,p=o.nextSibling;return t(o,()=>e("picker.intro")),t(n,l(b,{get propsTables(){return[...i,...a]},cssVarsTables:s}),p),t(n,l(h,{each:c,children:d=>l(x,{demo:d})}),null),n}})};export{D as PickerDocPage};
