import{u as p,bI as c,c as t,i as n,P as d,F as T,t as m,r as y,bJ as u,bK as b}from"./index-CKeO2Rhr.js";import{D as x}from"./ComponentDocLayout-MZfk8orS.js";import{D}from"./DocLayout-CMm5c9ou.js";var f=m('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Tag</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');y({"zh-CN":b,"en-US":u});const C=()=>{const e=p(),{propsTables:g}=c(),o=[{title:e("tag.demo.types"),code:`<Tag type="primary">Primary</Tag>
...
</div>`,desc:e("tag.demoDesc.scenes")}];return t(D,{get children(){var a=f(),r=a.firstChild,s=r.nextSibling,i=s.nextSibling;return n(s,()=>e("tag.intro")),n(a,t(d,{propsTables:g}),i),n(a,t(T,{each:o,children:l=>t(x,{demo:l})}),null),a}})};export{C as TagDocPage};
