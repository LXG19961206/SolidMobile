import{u as p,bn as d,c as s,i,P as b,F as y,t as f,r as g,bo as h,bp as u}from"./index-P1lRDETY.js";import{D as v}from"./ComponentDocLayout-CtiquoEF.js";import{D as x}from"./DocLayout-DOj4aLE1.js";var S=f('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style=font-size:1.75rem;font-weight:700>Sidebar</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');g({"zh-CN":u,"en-US":h});const F=()=>{const e=p(),{propsTables:o,cssVarsTables:n}=d(),r=[{title:e("sidebar.demo.basic"),code:`const items = [
  { key: 'form', title: 'Form' },
...
/>`,desc:e("sidebar.demoDesc.jsx")},{title:e("sidebar.demo.compact"),code:`<Sidebar compact
  ...
  activeKey={active()} onChange={setActive}
/>`,desc:e("sidebar.demoDesc.compact")}];return s(x,{get children(){var t=S(),c=t.firstChild,a=c.nextSibling,m=a.nextSibling;return i(a,()=>e("sidebar.intro")),i(t,s(b,{propsTables:o,cssVarsTables:n}),m),i(t,s(y,{each:r,children:l=>s(v,{demo:l})}),null),t}})};export{F as SidebarDocPage};
