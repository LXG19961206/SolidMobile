...
/>`,desc:e("citypicker.demoDesc.deepCascade")}];return n(_,{get children(){var i=P(),a=i.firstChild,l=a.nextSibling,r=l.nextSibling;return t(l,()=>e("citypicker.intro")),t(i,n($,{propsTables:s,cssVarsTables:o}),r),t(i,n(C,{each:c,children:p=>n(f,{demo:p})}),null),t(i,n(D,{}),null),i}})};export{A as CityPickerDocPage};
