import{m as c,an as d,c as t,r as m,ao as h,ap as C,i as n,P as v,F as g,D as b,a as I,t as f}from"./index-DvnxeU6a.js";var x=f('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Input</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');m({"zh-CN":C,"en-US":h});const w=()=>{const e=c(),{propsTables:o,cssVarsTables:r}=d(),s=[{title:e("input.demo.standalone"),code:`const [val, setVal] = createSignal('');
...
</Form>`,desc:e("input.demoDesc.form")}];return t(I,{get children(){var l=x(),p=l.firstChild,a=p.nextSibling,i=a.nextSibling;return n(a,()=>e("input.intro")),n(l,t(v,{propsTables:o,cssVarsTables:r}),i),n(l,t(g,{each:s,children:u=>t(b,{demo:u})}),null),l}})};export{w as InputDocPage};
