import{u as m,bE as b,c as n,i as t,P as d,F as f,bF as h,t as p,r as u,bG as g,bH as B}from"./index-B6S4VqrV.js";import{D as T}from"./ComponentDocLayout-BugC-Jcf.js";import{D as I}from"./DocLayout-Cj1_Lf3N.js";var k=p('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">TabBar</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');u({"zh-CN":B,"en-US":g});const y=()=>{const e=m(),{propsTables:r}=b(),s=[{title:e("tabbar.demo.basic"),code:`<TabBar defaultValue="home">
