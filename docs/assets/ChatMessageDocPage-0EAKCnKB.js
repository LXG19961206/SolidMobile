import{u as c,K as m,c as s,i as a,P as d,F as h,t as u,r as b,L as f,M}from"./index-rArlC41e.js";import{D as C}from"./ComponentDocLayout-zVyie46g.js";import{D as x}from"./DocLayout-VI5YmSXn.js";var y=u('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">ChatMessage</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');b({"zh-CN":M,"en-US":f});const S=()=>{const e=c(),{propsTables:n,cssVarsTables:o}=m(),l=[{title:e("chatMessage.demo.basic"),code:`<ChatMessage position="left" messageType="plainText"
