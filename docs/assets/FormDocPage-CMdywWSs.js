...
</Form>`,desc:e("form.demoDesc.full")}];return l(E,{get children(){var r=U(),F=r.firstChild,n=F.nextSibling,o=n.nextSibling,s=o.firstChild,d=s.nextSibling,I=d.nextSibling,i=I.firstChild,S=i.firstChild;S.nextSibling;var a=i.nextSibling,C=a.firstChild;C.nextSibling;var m=a.nextSibling,k=m.firstChild;k.nextSibling;var c=m.nextSibling,$=c.firstChild;$.nextSibling;var p=o.nextSibling,u=p.firstChild,R=u.nextSibling,f=R.firstChild,g=f.nextSibling,b=g.nextSibling,v=b.nextSibling,_=v.nextSibling;return p.nextSibling,t(n,()=>e("form.intro")),t(r,l(P,{propsTables:x,cssVarsTables:h}),o),t(s,()=>e("form.refApi.title")),t(d,()=>e("form.refApi.desc")),t(i,()=>e("form.refApi.setFormValue"),null),t(a,()=>e("form.refApi.resetFormValue"),null),t(m,()=>e("form.refApi.submit"),null),t(c,()=>e("form.refApi.validateAll"),null),t(u,()=>e("form.layout.desc")),t(f,()=>e("form.layout.item1")),t(g,()=>e("form.layout.item2")),t(b,()=>e("form.layout.item3")),t(v,()=>e("form.layout.item4")),t(_,()=>e("form.layout.item5")),t(r,l(w,{each:y,children:A=>l(B,{demo:A})}),null),r}})};export{M as FormDocPage};
