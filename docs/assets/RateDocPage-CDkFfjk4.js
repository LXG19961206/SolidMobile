import{u as m,b9 as p,c as a,i as o,P as b,F as u,t as v,r as g,ba as h,bb as f}from"./index-50QOYACL.js";import{D}from"./ComponentDocLayout-WBcSb-RT.js";import{D as x}from"./DocLayout-w8QP7Dbd.js";var R=v('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Rate</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');g({"zh-CN":f,"en-US":h});const F=()=>{const e=m(),{propsTables:l,cssVarsTables:s}=p(),n=[{title:e("rate.demo.basic"),code:`const [val, setVal] = createSignal(3);
...
</Form>`,desc:e("rate.demoDesc.form")}];return a(x,{get children(){var t=R(),c=t.firstChild,r=c.nextSibling,i=r.nextSibling;return o(r,()=>e("rate.intro")),o(t,a(b,{propsTables:l,cssVarsTables:s}),i),o(t,a(u,{each:n,children:d=>a(D,{demo:d})}),null),t}})};export{F as RateDocPage};
