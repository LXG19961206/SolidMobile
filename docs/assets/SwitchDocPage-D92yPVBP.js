...
</Form>`,desc:e("switch.demoDesc.form")}];return t(v,{get children(){var o=D(),r=o.firstChild,s=r.nextSibling,c=s.nextSibling,d=c.nextSibling;return i(s,()=>e("switch.intro")),i(c,()=>e("switch.note")),i(o,t(p,{propsTables:n,cssVarsTables:l}),d),i(o,t(b,{each:a,children:m=>t(u,{demo:m})}),null),o}})};export{z as SwitchDocPage};
