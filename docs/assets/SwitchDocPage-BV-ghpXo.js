import{u as g,by as h,c as t,i,P as p,F as b,t as f,r as w,bz as x,bA as T}from"./index-DgmvoJ5y.js";import{D as u}from"./ComponentDocLayout-Dv2yqQbp.js";import{D as v}from"./DocLayout-Bs01Q_bc.js";var S=f('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Switch</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><p style="padding:8px 12px;background:#fef3c7;border-radius:6px;font-size:0.85rem;color:#92400e"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');w({"zh-CN":T,"en-US":x});const z=()=>{const e=g(),{propsTables:n,cssVarsTables:l}=h(),a=[{title:e("switch.demo.basic"),code:`// ⚠ Import with alias to avoid SolidJS built-in <Switch>
...
</Form>`,desc:e("switch.demoDesc.form")}];return t(v,{get children(){var o=S(),r=o.firstChild,s=r.nextSibling,c=s.nextSibling,d=c.nextSibling;return i(s,()=>e("switch.intro")),i(c,()=>e("switch.note")),i(o,t(p,{propsTables:n,cssVarsTables:l}),d),i(o,t(b,{each:a,children:m=>t(u,{demo:m})}),null),o}})};export{z as SwitchDocPage};
