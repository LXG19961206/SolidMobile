import{u as d,K as p,c as s,i as a,P as m,F as h,t as u,r as f,L as M,M as b}from"./index-CVzp3uhx.js";import{D as C}from"./ComponentDocLayout-B8ZMQXRF.js";import{D as y}from"./DocLayout-BjtOUDOp.js";var x=u('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">ChatMessage</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');f({"zh-CN":b,"en-US":M});const A=()=>{const e=d(),{propsTables:n,cssVarsTables:o}=p(),l=[{title:"File Download",code:`<ChatMessage position="left" messageType="file"
