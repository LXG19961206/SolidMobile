import{m as r,az as c,c as o,r as p,aA as m,aB as L,i as t,P as x,F as f,D as y,a as u,t as h}from"./index-YBn7yUdg.js";var D=h('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Loading</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');p({"zh-CN":L,"en-US":m});const b=()=>{const e=r(),{propsTables:i}=c(),s=[{title:e("loading.demo.types"),code:`<Loading type="spinner" />
...
</Button>`,desc:e("loading.jsxDesc")}];return o(u,{get children(){var n=D(),d=n.firstChild,a=d.nextSibling,l=a.nextSibling;return t(a,()=>e("loading.intro")),t(n,o(x,{propsTables:i}),l),t(n,o(f,{each:s,children:g=>o(y,{demo:g})}),null),n}})};export{b as LoadingDocPage};
