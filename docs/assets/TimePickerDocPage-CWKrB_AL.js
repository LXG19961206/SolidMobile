import{u as h,bS as p,c as o,i as l,P as d,F as S,t as w,r as v,bT as u,bU as C}from"./index-P1lRDETY.js";import{D as k}from"./ComponentDocLayout-CtiquoEF.js";import{D as f}from"./DocLayout-DOj4aLE1.js";var g=w('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">TimePicker</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');v({"zh-CN":C,"en-US":u});const V=()=>{const e=h(),{propsTables:a,cssVarsTables:i}=p(),r=[{title:e("timepicker.demo.basic"),code:`const [show, setShow] = createSignal(false);
