import{u as d,bp as c,c as s,i as p,P as g,F as b,t as u,r as h,bq as v,br as S}from"./index-BuLtACo6.js";import{D as x}from"./ComponentDocLayout-tZbzDvbf.js";import{D}from"./DocLayout-dwotFMHY.js";var f=u('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Stepper</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');h({"zh-CN":S,"en-US":v});const z=()=>{const e=d(),{propsTables:o,cssVarsTables:a}=c(),l=[{title:e("stepper.demo.basic"),code:`const [val, setVal] = createSignal(0);
