import{u as g,K as d,c as s,i as a,P as m,F as c,t as h,r as u,L as f,M}from"./index-CRPgiqk2.js";import{D as y}from"./ComponentDocLayout-BDgywc5U.js";import{D as x}from"./DocLayout-B_bdwNwb.js";var C=h('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">ChatMessage</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');u({"zh-CN":M,"en-US":f});const D=()=>{const e=g(),{propsTables:o}=d(),n=[{title:e("chatMessage.demo.basic"),code:`<ChatMessage position="left" messageType="plainText"
