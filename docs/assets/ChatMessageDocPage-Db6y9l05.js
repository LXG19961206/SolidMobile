...
/>`,desc:e("chatMessage.demoDesc.longPressCustom")},{title:e("chatMessage.demo.longPressSelect"),code:`<ChatMessage position="left" messageType="plainText"
  ...
  selectOnLongPress
/>`,desc:e("chatMessage.demoDesc.longPressSelect")}];return s(b,{get children(){var t=T(),g=t.firstChild,n=g.nextSibling,i=n.nextSibling,d=i.nextSibling;return a(n,()=>e("chatMessage.intro")),a(i,()=>e("chatMessage.note")),a(t,s(f,{propsTables:o,cssVarsTables:l}),d),a(t,s(x,{each:c,children:r=>s(C,{demo:r})}),null),t}})};export{v as ChatMessageDocPage};
