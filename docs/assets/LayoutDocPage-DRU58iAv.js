import{u as r,ao as C,c as n,i as a,P as m,F as v,t as c,r as g,ap as f,aq as u}from"./index-vxgISfrQ.js";import{D as y}from"./ComponentDocLayout-gyAvD6KU.js";import{D as w}from"./DocLayout-CqUTNkUG.js";var h=c('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Layout</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');g({"zh-CN":u,"en-US":f});const b=()=>{const o=r(),{propsTables:s}=C(),i=[{title:o("layout.demo.grid"),code:`<Row gap={8}>
