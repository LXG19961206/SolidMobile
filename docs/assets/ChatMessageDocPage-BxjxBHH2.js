import{u as d,K as p,c as s,i as a,P as m,F as h,t as u,r as f,L as M,M as b}from"./index-Dh_DZKbR.js";import{D as C}from"./ComponentDocLayout-DfDJoBz6.js";import{D as x}from"./DocLayout-CcVJyJAM.js";var y=u('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">ChatMessage</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');f({"zh-CN":b,"en-US":M});const D=()=>{const e=d(),{propsTables:n,cssVarsTables:o}=p(),l=[{title:e("chatMessage.demo.fileDownload"),code:`<ChatMessage position="left" messageType="file"
  ...
  name="Alice" time="10:35" avatar="alice.jpg" />`,desc:e("chatMessage.demoDesc.fileDownload")},{title:e("chatMessage.demo.basic"),code:`<ChatMessage position="left" messageType="plainText"
...
/>`,desc:"Custom JSX mode: full control over menu layout. Still uses Tooltip for positioning."},{title:e("chatMessage.demo.longPressSelect"),code:`<ChatMessage position="left" messageType="plainText"
  ...
  selectOnLongPress
/>`,desc:"selectOnLongPress selects all bubble text on hold. Mutually exclusive with longPressMenu."}];return s(x,{get children(){var t=y(),c=t.firstChild,i=c.nextSibling,r=i.nextSibling;return a(i,()=>e("chatMessage.intro")),a(t,s(m,{propsTables:n,cssVarsTables:o}),r),a(t,s(h,{each:l,children:g=>s(C,{demo:g})}),null),t}})};export{D as ChatMessageDocPage};
