import{u as p,S as m,c as a,i as l,P as D,F as g,t as h,r as k,T as C,U as v}from"./index-D-IIFxNK.js";import{D as b}from"./ComponentDocLayout-zB7XwCMj.js";import{D as V}from"./DocLayout-Hbik8FUD.js";var S=h('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">DatePicker</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');k({"zh-CN":v,"en-US":C});const f=()=>{const e=p(),{propsTables:i,cssVarsTables:o}=m(),s=[{title:e("datepicker.demo.basic"),code:`const [open, setOpen] = createSignal('');
