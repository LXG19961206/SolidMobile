import{m as d,Q as r,c as l,r as x,R as k,S as u,i as a,P as C,F as m,D as v,a as p,t as g}from"./index-DvnxeU6a.js";var G=g('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Checkbox</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');x({"zh-CN":u,"en-US":k});const A=()=>{const e=d(),{propsTables:n,cssVarsTables:s}=r(),t=[{title:e("checkbox.demo.basic"),code:`const [vals, setVals] = createSignal<unknown[]>([]);
...
</Form>`,desc:e("checkbox.demoDesc.form")}];return l(p,{get children(){var o=G(),b=o.firstChild,c=b.nextSibling,h=c.nextSibling;return a(c,()=>e("checkbox.intro")),a(o,l(C,{propsTables:n,cssVarsTables:s}),h),a(o,l(m,{each:t,children:i=>l(v,{demo:i})}),null),o}})};export{A as CheckboxDocPage};
