import{m as u,aU as m,c as o,r as p,aV as v,aW as h,i as l,P as b,F as R,D as g,a as C,t as x}from"./index-YBn7yUdg.js";var G=x('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Radio</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');p({"zh-CN":h,"en-US":v});const D=()=>{const e=u(),{propsTables:n,cssVarsTables:d}=m(),r=[{title:e("radio.demo.basic"),code:`const [val, setVal] = createSignal('a');
...
</Form>`,desc:e("radio.demoDesc.form")}];return o(C,{get children(){var a=G(),t=a.firstChild,i=t.nextSibling,s=i.nextSibling;return l(i,()=>e("radio.intro")),l(a,o(b,{propsTables:n,cssVarsTables:d}),s),l(a,o(R,{each:r,children:c=>o(g,{demo:c})}),null),a}})};export{D as RadioDocPage};
