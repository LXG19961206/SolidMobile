import{f as v,c as r,i as d,F as m,t as p,r as D}from"./index-CjqJoD8k.js";import{D as h}from"./ComponentDocLayout-7lKpA80h.js";import{u as x,e as f,z as g}from"./tableData-BlOzHPO3.js";import{P as z}from"./PropsAttrs-BEGKasrA.js";import{D as u}from"./DocLayout-BMuVmMAz.js";var y=p('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Divider</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');D({"zh-CN":g,"en-US":f});const $=()=>{const e=v(),{propsTables:o,cssVarsTables:s}=x(),n=[{title:e("divider.demo.horizontal"),code:`<div>Content above</div>
<Divider />
...
<Divider color="#22c55e" dashed text="Green dashed" />`,desc:e("divider.demoDesc.color")},{title:e("divider.demo.vertical"),code:`<div style={{ display: "flex", gap: "12px", "align-items": "center" }}>
  ...
  <span>Four</span>
</div>`,desc:e("divider.demoDesc.vertical")}];return r(u,{get children(){var i=y(),a=i.firstChild,t=a.nextSibling,c=t.nextSibling;return d(t,()=>e("divider.intro")),d(i,r(z,{propsTables:o,cssVarsTables:s}),c),d(i,r(m,{each:n,children:l=>r(h,{demo:l})}),null),i}})};export{$ as DividerDocPage};
