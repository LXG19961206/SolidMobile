import{m as c,k as l,c as n,r as m,l as p,n as B,i as a,P as b,F as h,D as u,a as x,t as D}from"./index-YBn7yUdg.js";var w=D('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Badge</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');m({"zh-CN":B,"en-US":p});const z=()=>{const e=c(),{propsTables:d}=l(),s=[{title:e("badge.demo.withAvatar"),code:`<Badge content={5}>
  <Avatar size={40} />
</Badge>
<Badge dot>
  <Avatar size={40} />
...
<span>Done <Badge content="✓" color="#22c55e" /></span>`,desc:e("badge.demoDesc.standalone")}];return n(x,{get children(){var t=w(),i=t.firstChild,o=i.nextSibling,g=o.nextSibling;return a(o,()=>e("badge.intro")),a(t,n(b,{propsTables:d}),g),a(t,n(h,{each:s,children:r=>n(u,{demo:r})}),null),t}})};export{z as BadgeDocPage};
