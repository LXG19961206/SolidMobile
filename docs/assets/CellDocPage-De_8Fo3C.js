import{u as m,D as p,c as t,i,P as u,F as C,t as b,r as h,E as f,G as g}from"./index-Dm-WWXOF.js";import{D}from"./ComponentDocLayout-DuzjJJVc.js";import{D as x}from"./DocLayout-TPU7x6K4.js";var v=b('<div style="padding:24px 32px;max-width:960px;margin:0 auto"><h1 style="font-size:1.75rem;font-weight:700;margin:0 0 4px">Cell / CellGroup</h1><p style="font-size:0.9rem;color:#6b7280;margin:0 0 24px"></p><h2 style="font-size:1.1rem;font-weight:600;margin:24px 0 12px">Demos');h({"zh-CN":g,"en-US":f});const P=()=>{const e=m(),{propsTables:r,cssVarsTables:s}=p(),c=[{title:e("cell.demo.basic"),code:`<CellGroup title="Basic Info">
