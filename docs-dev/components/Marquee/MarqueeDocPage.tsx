...
export const MarqueeDocPage = () => {
  ...
  const demos: DemoCode[] = [
    ...
    { title: t('marquee.demo.notify'), code: '<Marquee duration={8}>\n  <span onClick={() => Notify.show({ message: \'Hello!\', duration: 0 })}\n    style={{ cursor: \'pointer\', color: \'var(--sc-color-primary)\' }}>\n    📢 Click to trigger Notify (manual dismiss)\n  </span>\n</Marquee>', desc: t('marquee.demoDesc.notify') },
  ];
