export default {
  chatMessage: {
    props: {
      ...
      name: 'Sender name for group chats. Overridden by headerSlot.',
      headerSlot: 'Custom JSX above bubble, replaces name when provided.',
      time: 'Timestamp string. Overridden by footerSlot.',
      footerSlot: 'Custom JSX below bubble, replaces time + status when provided.',
