  ...
  return (
    <MobilePreview title="ChatMessage">
      ...
      <div style={{ padding: '10px 12px', display: 'flex', 'flex-direction': 'column', 'min-height': '100%' }}>
        ...
        {/* ── Status ── */}
        <ChatMessage position="right" messageType="plainText"  content="Sent ✓" time="10:36" status="sent" />
        <ChatMessage position="right" messageType="plainText"  content="Read ✓" time="10:37" status="read" />
        <ChatMessage position="right" messageType="plainText"  content="Sending..." time="10:38" status="sending" />
        <ChatMessage position="right" messageType="plainText"  content="This one failed..." time="10:39" status="failed" onRetry={() => Toast.info('Retrying...')} />

        {/* ── Status Positions ── */}
        <ChatMessage position="right" messageType="plainText"  content="status after time (default)" time="10:40" status="read" />
        <ChatMessage position="right" messageType="plainText"  content="status inside bubble" time="10:41" status="sending" statusPosition="bubble" />
        ...
        <ChatMessage position="right" messageType="plainText"  content="Custom JSX menu" time="10:45"
