  ...
  return (
    <MobilePreview title="ChatMessage">
      ...
      <div style={{ padding: '10px 12px', display: 'flex', 'flex-direction': 'column', background: '#f8f9fb', 'min-height': '100%' }}>
        ...
        <ChatMessage position="left" messageType="file" bgColor="#dbeafe" file={new File(['x'.repeat(2500000)], 'design-spec.pdf', { type: 'application/pdf' })} name="Alice" time="10:36" avatar={A} />
