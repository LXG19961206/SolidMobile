    ...
    <DocLayout>
      <div style={{ padding: '24px 32px', 'max-width': '960px', margin: '0 auto' }}>
        ...
        <div style={{ background: '#f8f9fb', border: '1px solid #e5e7eb', 'border-radius': '12px', padding: '12px 0', 'margin-bottom': '24px', 'max-width': '520px' }}>
          ...
          {/* File + Custom */}
          <ChatMessage position="left" messageType="file" bgColor="#dbeafe" fileName="design-spec.pdf" fileSize="2.4 MB" src="./logo.jpg" name="Alice" time="11:20" avatar={AVATAR_ALICE} />
          <ChatMessage position="right" messageType="file" fileName="report.xlsx" fileSize="1.8 MB" progress={65} src="https://example.com/report.xlsx" time="11:21" status="sending" onDownload={() => alert('Custom download handler fired!\nReal use case: bridge.download(url)')} />
