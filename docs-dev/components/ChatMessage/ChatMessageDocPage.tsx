    ...
    <DocLayout>
      <div style={{ padding: '24px 32px', 'max-width': '960px', margin: '0 auto' }}>
        ...
        <div style={{ background: '#f8f9fb', border: '1px solid #e5e7eb', 'border-radius': '12px', padding: '12px 0', 'margin-bottom': '24px', 'max-width': '520px' }}>
          ...
          {/* File + Custom */}
          <ChatMessage position="left" messageType="file" bgColor="#dbeafe" iconMap={{ pdf: '📄', doc: '📝', image: '🖼️', '*': '📎' }} file={new File(['x'.repeat(2500000)], 'design-spec.pdf', { type: 'application/pdf' })} name="Alice" time="11:20" avatar={AVATAR_ALICE} />
