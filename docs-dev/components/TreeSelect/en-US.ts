export default {
  treeselect: {
    props: {
      ...
      onSearch: 'Async search callback. When provided, typing calls this instead of local filtering.',
      renderItem: 'Custom render for each option. (node, selected, expand, toggle) => JSX.Element; toggle switches selection.',
      placeholder: 'Placeholder text when empty.',
      title: 'Overlay title.',
      disabled: 'Disable the component.',
      onLoadChildren: 'Async children loader. Nodes without children become expandable when provided.',
    ...
    demoDesc: {
      ...
      bigData: '1,800 options. With global search, typing a keyword instantly locates any item across the whole tree. Results are capped at 100 rows.',
    },
