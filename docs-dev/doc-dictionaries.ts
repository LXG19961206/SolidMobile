...
export const docMessages: LocaleMessages = {
  ...
  demoDesc: {
      ActionSheet_6eebe3: '传入 items 数组。',
      ActionSheet_d0e1d5: 'description 显示在标题下方。',
      Avatar_84c7b4: '不传 src 时显示 icon 图标。',
      Avatar_2b5e31: '不传 src 和 icon 时，取 text 的第一个字符。',
      Avatar_8faa2a: 'square 替代 round，适合品牌 logo。',
      Badge_f20575: '最常见场景——头像角标表示未读消息。',
      Badge_3ee07b: '按钮角标提示待处理数量。',
      Badge_cd529c: 'Tab 徽标提示各分类下的数量。',
      Badge_05e398: '不包裹子元素时原地渲染，适合列表项右侧的状态标记。',
      Button_897946: '四档尺寸：xs (28px) / sm (32px) / md (40px) / lg (48px)',
      Button_17ff27: 'solid（实心）、outline（线框）、ghost（透明）三种填充方式，与 type 正交组合。',
      Button_fc30d0: '完全圆角，适合标签或筛选按钮。',
      Button_d0223b: '纯图标按钮必须设置 aria-label 以保证无障碍访问。',
      Button_1cdd2f: '设置 href 后自动渲染为 <a> 标签，支持 target 控制打开方式。',
      Button_0cb62a: '直接覆盖背景色，文字色自动计算对比度。也可手动指定 textColor。',
      Button_f792ef: 'Primary 主操作 + Outline 取消，右对齐。',
      Button_a607b7: 'block + round + size=lg，适合移动端底部固定区域。',
      Button_ad33a5: 'danger 变体用于删除类操作，搭配 outline 取消。',
      Calendar_30c08e: '弹出模式，标题自动跟随滚动月份。',
      Calendar_4959ce: 'range + showConfirm，标题同上动态。若需固定可传 title。',
      Calendar_ed7546: 'range 模式展示，activeColor 改选中色，dayRender 自定义格子。',
      Calendar_fa863a: '通过 dayRender 自定义格子内容，标记周末和节假日。',
      Calendar_311a7e: 'popup={false} 直接嵌入页面。',
      Calendar_4863c8: 'lunar={true} 启用农历显示，月初显示月名、其他显示日名，节气日显示节气名。',
      Cascader_ee3834: '三级联动选择，选中叶子节点自动关闭。点击顶部 Tab 可回退到已选层级。',
      Cascader_39a6d1: '设置 disabled: true 可禁用特定选项，点击无反应。',
      Cascader_0f70da: 'options 初始为空，每级由 onLoadChildren 按需拉取。模拟 2s 网络延迟。',
      Cell_285074: 'Cell 由 title（左）、value（右）、description（下）三部分组成。',
      Cell_0451f7: '设置 clickable 后右侧显示箭头，整行可点击。配合 onClick 处理跳转。',
      Cell_35f866: 'icon / title / value 均支持字符串或 JSX。required 显示红色星号。',
      Cell_786ca3: '三种尺寸，默认 md（48px）。',
      Cell_b48e3e: 'CellGroup 设置 card 获得圆角和独立背景，适合在灰色背景页面上使用。',
      Center_4b8b37: '不传任何参数时，默认 flex 水平 + 垂直居中。这是最常用的场景。',
      Center_19f238: '只居中水平方向。',
      Center_dd3155: '只居中垂直方向（父级需有高度）。',
      Center_82f338: '加 inline 变为 inline-flex，不换行。',
      Center_334839: 'text-align: center，适合行内或行内块内容。',
      Center_3ed382: 'vertical-align: middle，适合行内元素对齐。',
      Checkbox_d4f474: 'max 限制最多可选数，min 限制最少可选数。',
      Checkbox_3fcd5f: 'Checkbox 脱离 CheckboxGroup 单独使用，支持受控和非受控。',
      CityPicker_3f0c2e: '直接使用 Picker 组件，传入 6 层深度的树形数据即可自动级联。',
      Dialog_7c0c0c: '基础提示，仅确认按钮。',
      Dialog_88629b: '带取消按钮，常用于删除确认。',
      Dialog_2978dd: '不传 title 时只展示内容。',
      Dialog_29c178: 'message 中的 \\n 自动换行。',
      Dialog_cced09: '通过 confirmText / cancelText 自定义按钮文字。',
      Dialog_ea0953: 'message 支持传入 JSX。',
      Dialog_50382e: 'onConfirm 异步时自动展示 Loading。',
      Dialog_601c3b: '通过 show 属性受控显示，适合需要将弹窗嵌入模板的场景。',
      Divider_9faa97: `direction='vertical'，行内使用。`,
      Empty_7e7d97: `image 支持 'default'（通用）、'network'（网络异常）、'search'（无搜索结果）三种预设。`,
      Empty_e1269e: 'image 支持传入任意 JSX，不再局限于内置图标。',
      Empty_eb74ab: 'children 传入按钮，支持自定义操作。',
      Icon_fd97fe: '从 solid-component/icons 导入单个图标组件，打包工具自动 tree-shake，只打包实际使用的图标。',
      Icon_a6e05e: '使用 &lt;Icon name=&quot;...&quot; /&gt; 通过 name 属性动态指定图标，适合图标名来自变量、配置或数据库的场景。',
      Icon_473e84: `variant='line'（默认）为线性空心风格，variant='fill' 为填充实心风格。`,
      Icon_9ef12f: 'size 支持数字（自动补 px）或任意 CSS 单位字符串。',
      Icon_cb6632: 'color 属性设置图标颜色，不设置时继承父级文字颜色（currentColor）。',
      Icon_032e64: '设置 aria-label 和 style 将图标变为可交互按钮，配合 cursor:pointer 提示可点击。',
      Image_d3eb23: 'solid-mobile 官方 logo。',
      Image_a208d5: '通过 fit 控制 object-fit 行为。容器为正方形，源图 4:3。',
      Image_3242f6: '加载中显示占位内容，可自定义。',
      Image_414d5a: '加载失败时显示兜底内容。',
      Input_dbab86: '输入内容后右侧显示 X 按钮，点击清空。',
      Input_20bbd4: 'prefix + clearable 实现搜索输入框。',
      Input_283b78: '三种状态对比。error 底部出现红色波浪线，适合独立使用时的校验反馈。',
      Input_ac814c: '手机号输入框右侧挂一个发送验证码按钮，点击后 60s 倒计时。',
      Input_0a65da: 'Input 通过 useFormField() 自动接入 FormItem Context，无需手动传 value/onChange。',
      Layout_179f32: 'Col 的 span 取值 1-24，总和超出自动换行。',
      Layout_b69586: 'offset 设置左偏移，同样基于 24 栅格。',
      Layout_ed9299: 'Row 的 gap 控制列间距，align 控制垂直对齐。',
      Lazyload_c67bf5: '上部 320px 是说明区，下面的文档卡片被推出视口。向下滚动后卡片逐个进入视口触发懒加载。',
      Lazyload_b57dce: '点击按钮触发 active，同样经历 Loading → 显示内容的延迟过程。',
      Lazyload_f92371: '上部 280px 标题区推出网格，向下滚动后彩色卡片逐个触发。',
      List_8254e3: '切换 Tab 查看不同模式。每个 Tab 独立管理数据源，互不干扰。',
      Loading_ba259a: '三种内置动画：spinner 经典旋转圆环、circular 弧形旋转、dots 三点弹跳。',
      Loading_d8df97: '不传 text / children 时只显示动画，适合按钮内或行内场景。',
      Loading_960681: 'size 支持数字（px）或 CSS 字符串，color 设置动画颜色。',
      Loading_b4bdf2: '设为 true 时文字显示在动画下方，适合卡片或全屏加载场景。',
      Loading_424b16: '传入自定义 JSX 替代内置动画。适合配合 Icon 组件实现旋转刷新等交互。',
      Loading_440446: '设为 true 时渲染全屏半透明遮罩并锁定滚动，适合阻止用户操作的等待场景。',
      NavBar_e337c0: 'fixed + placeholder。手机模拟器的 transform 会创建新的定位上下文，fixed 自动局限在手机屏幕内。',
      NavBar_9a25d7: '最简单的导航栏，只有标题。',
      NavBar_dc222b: '设置 backArrow 显示返回图标，onBack 处理点击。',
      NavBar_018a97: 'right 可传入按钮、图标或任意 JSX。',
      NavBar_85969c: 'left 和 right 同时自定义，适合复杂操作栏。',
      Overlay_e1fbb3: '居中对话框，点击背景关闭。',
      Overlay_a536f6: 'ActionSheet 内部使用 Overlay。',
      PullRefresh_744757: '自定义各状态文案。',
      PullRefresh_771d32: 'List 内置 pullRefresh 属性，开启后自动集成下拉刷新。',
      Radio_9e7b07: 'Radio 脱离 RadioGroup 单独使用，自行管理选中态。',
      Rate_c03c81: 'count 控制图标总数。',
      Rate_a4dc0c: 'size 图标大小，gutter 间距。',
      Rate_5fcde2: 'readonly 状态无法交互。',
      SafeArea_9008f0: '放在页面顶部，避开刘海和状态栏。',
      SafeArea_148eb1: '放在页面底部，避开 Home Indicator。',
      Select_1bb2e9: '不传 show 时，Select 自行管理面板开关，点击即可选择。',
      Select_74fb50: '放在 FormItem 中自动集成表单的值管理。',
      Slider_a1b9a6: 'count=2 时出现两个滑块，控制一个范围。',
      Slider_158709: 'count=3 三个滑块，value 为长度为 3 的数组。',
      Slider_e13576: '自定义颜色、进度条高度、滑块大小。',
      Slider_bf6fed: 'thumbRender 接收当前值，返回自定义内容渲染滑块按钮。',
      Swiper_5504e6: 'imgUrls + autoplay 自动轮播。',
      Swiper_c0396f: 'vertical=true，上下滑动切换。',
      Switch_c7b8b5: '不传 checked，组件自行管理开关状态。',
      Switch_43d05a: '支持数字（px）或 CSS 字符串，默认 28。',
      Switch_7019f0: '禁用后不可点击，整体降低透明度。',
      TabBar_be21e4: 'Badge + dot 展示未读消息数。',
      TabBar_d9a034: 'icon 属性接受任意 JSX，TabBarItem 自动注入 active 布尔 prop，组件据此切换选中态样式。适合 Lottie / Rive / CSS animation 等方案。',
      TabBar_d884da: '默认 fixed=true，固定在模拟器底部并占位，模拟真实 App 底部导航体验。',
      Tabs_99dfd3: `type='line'，底部指示条跟随切换。`,
      Tabs_5b4b6a: 'title 支持传入任意 JSX。',
      Tabs_362ac5: `type='card'，卡片式标签栏。`,
      Tabs_c45890: '外部管理激活状态，可设置 disabled 禁用选项。',
      Tag_643073: '用 outline variant 模拟 key-value 字典效果。',
      Tag_fe51cb: '不同语义色搭配 round 胶囊样式，模拟文章标签或筛选条件。',
      Tag_bdbb47: 'closeable 标签模拟已选筛选条件，可逐个移除。',
      Textarea_c9bfb7: '内容超出时自动扩展高度，可限制最小/最大行数。',
      Textarea_e79cb8: 'contentFlex 让 Textarea 自动拉伸撑满剩余宽度。',
      Toast_595797: '点击 Cell 弹出对应类型。',
      Toast_5aa746: 'Error / Loading 默认开启 overlay 防止误触。',
      Toast_ac79b4: '加载中带遮罩，阻止背景操作。',
      Upload_ab6777: 'iconMap 按文件后缀指定图标，支持内置图标名或自定义 JSX。特殊 key image/video/audio 匹配 MIME 类别，* 为兜底。',
      Upload_4bf4f8: 'maxCount 限制数量，maxSize 限制单文件大小，beforeUpload 自定义校验。',
      Upload_144f6a: '通过 fileList + onChange 完全接管文件列表。',
      Upload_5f5797: 'onSuccess / onError 监听单个文件的上传结果，适合做提示或埋点。',
      Upload_deaef6: '传入 children 替代默认的 + 按钮。',
      Upload_b331f5: 'renderFile + children 完全接管文件项和添加按钮的渲染。',
      notify_00b669: '主要通知。',
      notify_36fe53: '成功通知。',
      notify_4e003b: '警告通知。',
      notify_012010: '危险通知。',
      notify_30bbd5: 'duration: 0 手动关闭。',
  },
  componentProps: {
      picker: {
  ...
  demoDesc: {
      ActionSheet_6eebe3: 'Pass the items array.',
      ActionSheet_d0e1d5: 'Description displayed below the title.',
      Avatar_84c7b4: 'Shows icon when src is not provided.',
      Avatar_2b5e31: 'When no src or icon, shows first character of text.',
      Avatar_8faa2a: 'Square shape for brand logos instead of round.',
      Badge_f20575: 'Badge on avatar for unread message count.',
      Badge_3ee07b: 'Badge on button for pending item count.',
      Badge_cd529c: 'Badge on tab for per-category count.',
      Badge_05e398: 'Standalone badge without wrapping a child element.',
      Button_897946: 'Four sizes: xs (28px) / sm (32px) / md (40px) / lg (48px).',
      Button_17ff27: 'Solid, outline, and ghost variants, orthogonal to type.',
      Button_fc30d0: 'Fully rounded pill shape for tags or filter buttons.',
      Button_d0223b: 'Icon-only button must set aria-label for accessibility.',
      Button_1cdd2f: 'Renders as anchor tag when href is set. Supports target attribute.',
      Button_0cb62a: 'Override background color; text color auto-calculated. Can also set textColor manually.',
      Button_f792ef: 'Primary action + outline cancel, right-aligned.',
      Button_a607b7: 'Block + round + size=lg for mobile bottom bar.',
      Button_ad33a5: 'Danger variant for destructive actions, paired with outline cancel.',
      Calendar_30c08e: 'Popup mode with title auto-following the month.',
      Calendar_4959ce: 'Range mode with confirm. Title is dynamic; pass title for fixed text.',
      Calendar_ed7546: 'Range mode. activeColor for selection, dayRender for custom cells.',
      Calendar_fa863a: 'Use dayRender to mark weekends and holidays.',
      Calendar_311a7e: 'Use popup={false} to embed inline.',
      Calendar_4863c8: 'Enable lunar calendar with lunar={true}. Shows month name on first day, solar terms on term days.',
      Cascader_ee3834: 'Three-level cascade. Auto-closes on leaf. Click tabs to go back.',
      Cascader_39a6d1: 'Set disabled: true to disable options.',
      Cascader_0f70da: 'Empty options initially; each level loaded via onLoadChildren. Simulates 2s latency.',
      Cell_285074: 'Cell has three parts: title (left), value (right), description (bottom).',
      Cell_0451f7: 'Shows arrow when clickable; entire row is tappable. Use onClick for navigation.',
      Cell_35f866: 'icon, title, value all support strings or JSX. required shows a red asterisk.',
      Cell_786ca3: 'Three sizes, default md (48px).',
      Cell_b48e3e: 'CellGroup with card style for rounded corners and separate background.',
      Center_4b8b37: 'Default both-axis flex centering. The most common use case.',
      Center_19f238: 'Center horizontally only.',
      Center_dd3155: 'Center vertically only (parent needs height).',
      Center_82f338: 'Add inline for inline-flex without wrapping.',
      Center_334839: 'text-align: center for inline/inline-block content.',
      Center_3ed382: 'vertical-align: middle for inline element alignment.',
      Checkbox_d4f474: 'max limits max selections, min sets minimum.',
      Checkbox_3fcd5f: 'Standalone checkbox outside CheckboxGroup. Controlled and uncontrolled modes.',
      CityPicker_3f0c2e: 'Use Picker directly with 6-level tree data for auto-cascading.',
      Dialog_7c0c0c: 'Basic alert with confirm button only.',
      Dialog_88629b: 'With cancel button for delete confirmation.',
      Dialog_2978dd: 'Content only when no title.',
      Dialog_29c178: 'Newlines in message are auto-wrapped.',
      Dialog_cced09: 'Custom button text via confirmText/cancelText.',
      ...
      Icon_fd97fe: 'Import from solid-component/icons. Bundler tree-shakes unused icons.',
      Icon_a6e05e: 'Use <Icon name="..." /> for dynamic icons from variables, config, or database.',
      Icon_473e84: `variant='line'（默认）为线性空心风格，variant='fill' 为填充实心风格。`,
      Icon_9ef12f: 'size supports numbers (px) or any CSS unit string.',
      Icon_cb6632: 'color sets icon color; inherits parent text color when not set.',
      Icon_032e64: 'Set aria-label and cursor style for clickable, accessible icons.',
      Image_d3eb23: 'The official solid-mobile logo.',
      Image_a208d5: 'Control object-fit via fit. Container is square, source is 4:3.',
      Image_3242f6: 'Show placeholder while loading; customizable.',
      Image_414d5a: 'Show fallback content on load error.',
      Input_dbab86: 'Clear button appears on right when typed; click to clear.',
      Input_20bbd4: 'prefix + clearable for search input.',
      Input_283b78: 'Three states compared. error shows red wavy underline for validation.',
      Input_ac814c: 'Phone input with SMS code button and 60s countdown.',
      Input_0a65da: 'Input auto-connects to FormItem context via useFormField(). No manual value/onChange needed.',
      Layout_179f32: 'Col span is 1-24. Total exceeding 24 wraps automatically.',
      Layout_b69586: 'offset sets left margin on 24-grid.',
      Layout_ed9299: 'Row gap for column spacing, align for vertical alignment.',
      Lazyload_c67bf5: 'Top 320px is description; scroll down for lazy-load cards.',
      Lazyload_b57dce: 'Click to toggle active, showing Loading → content lifecycle.',
      Lazyload_f92371: 'Top 280px pushes grid out; scroll for colored cards.',
      List_8254e3: 'Switch tabs for different modes. Each tab manages its own data.',
      Loading_ba259a: 'Three animations: spinner, circular, dots.',
      Loading_d8df97: 'Animation only without text. Suitable for inline or button use.',
      Loading_960681: 'size supports numbers (px) or CSS strings. color sets animation color.',
      Loading_b4bdf2: 'Text below animation when true. For cards or fullscreen loading.',
      Loading_424b16: 'Custom JSX to replace built-in animation.',
      Loading_440446: 'Fullscreen overlay with scroll lock when true.',
      NavBar_e337c0: 'fixed + placeholder for top positioning.',
      NavBar_9a25d7: 'Simplest navbar with just a title.',
      NavBar_dc222b: 'Show back arrow; onBack handles click.',
      NavBar_018a97: 'right slot accepts buttons, icons, or any JSX.',
      NavBar_85969c: 'Custom left and right areas for complex action bars.',
      Overlay_e1fbb3: 'Centered dialog; click backdrop to close.',
      Overlay_a536f6: 'ActionSheet uses Overlay internally.',
      PullRefresh_744757: 'Customize status text for each state.',
      PullRefresh_771d32: 'List has built-in pullRefresh prop for integration.',
      Radio_9e7b07: 'Standalone radio outside RadioGroup with self-managed state.',
      Rate_c03c81: 'count controls total icon count.',
      Rate_a4dc0c: 'size for icon size, gutter for spacing.',
      Rate_5fcde2: 'Non-interactive in readonly state.',
      SafeArea_9008f0: 'Place at top to avoid notch and status bar.',
      SafeArea_148eb1: 'Place at bottom to avoid Home Indicator.',
      Select_1bb2e9: 'When show is omitted, Select manages its own state.',
      Select_74fb50: 'Inside FormItem for automatic form value management.',
      Slider_a1b9a6: 'count=2 for dual-thumb range control.',
      Slider_158709: 'count=3 for triple-thumb; value is length-3 array.',
      Slider_e13576: 'Custom colors, track height, and thumb size.',
      Slider_bf6fed: 'thumbRender receives current value for custom thumb.',
      Swiper_5504e6: 'imgUrls + autoplay for auto-rotation.',
      Swiper_c0396f: 'vertical=true for up/down swipe.',
      Switch_c7b8b5: 'Self-managed when checked is not passed.',
      Switch_43d05a: 'Supports numbers (px) or CSS strings. Default 28.',
      Switch_7019f0: 'Non-interactive when disabled; reduced opacity.',
      TabBar_be21e4: 'Badge + dot for unread message count.',
      TabBar_d9a034: 'Icon accepts any JSX. TabBarItem auto-injects active boolean prop.',
      TabBar_d884da: 'Fixed to bottom with placeholder for native app feel.',
      Tabs_99dfd3: `type='line'，底部指示条跟随切换。`,
      Tabs_5b4b6a: 'title supports arbitrary JSX.',
      Tabs_362ac5: `type='card'，卡片式标签栏。`,
      Tabs_c45890: 'External active state management; can disable options.',
      Tag_643073: 'outline variant for key-value dictionary style.',
      Tag_fe51cb: 'Semantic colors with round pill style for tags or filters.',
      Tag_bdbb47: 'closeable tags for removable filter chips.',
      Textarea_c9bfb7: 'Auto-expands on overflow with min/max row limits.',
      Textarea_e79cb8: 'contentFlex makes Textarea fill remaining width.',
      Toast_595797: 'Click each Cell for corresponding toast type.',
      Toast_5aa746: 'Error/Loading enable overlay by default.',
      Toast_ac79b4: 'Loading with overlay blocks background.',
      Upload_ab6777: 'iconMap maps extensions to icons. Special keys: image/video/audio for MIME, * for fallback.',
      Upload_4bf4f8: 'maxCount limits files; maxSize limits per-file; beforeUpload for validation.',
      Upload_144f6a: 'Full control via fileList + onChange.',
      Upload_5f5797: 'onSuccess/onError for per-file upload results. For toasts or analytics.',
      Upload_deaef6: 'Pass children to replace default + button.',
      Upload_b331f5: 'renderFile + children for full custom rendering.',
      notify_00b669: 'Primary notification.',
      notify_36fe53: 'Success notification.',
      notify_4e003b: 'Warning notification.',
      notify_012010: 'Danger notification.',
      notify_30bbd5: 'Manual close with duration: 0.',
  },
  componentProps: {
      picker: {
      ...
      calendar: {
        ...
        readonly: 'Readonly.',
        lunar: 'Show lunar calendar info.',
