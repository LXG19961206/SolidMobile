...
const groupProps: PropRow[] = [
  { name: 'value', type: 'unknown', default: '—', required: false, desc: 'componentProps.Radio.value' },
  { name: 'defaultValue', type: 'unknown', default: '—', required: false, desc: 'componentProps.Radio.defaultValue' },
  { name: 'onChange', type: '(value) => void', default: '—', required: false, desc: 'componentProps.Radio.onChange' },
