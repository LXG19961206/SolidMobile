...
const ActionSheetDocInner = () => {
  ...
  return (
    <div style={{ padding: '16px', 'max-width': '960px' }}>
      ...
      <DemoBlock title={t('demo.actionOptions')} desc={t('demoDesc.actionsheet_items')} code={`<ActionSheet open={open} onClose={...} items={items} />`} groupCode="基础">
      ...
      <DemoBlock title={t('demo.actionDesc')} desc={t('demoDesc.actionsheet_description')} code={`<ActionSheet open={open} title="确认删除？" description="..." items={items} cancelText="取消" />`} groupCode="基础">
