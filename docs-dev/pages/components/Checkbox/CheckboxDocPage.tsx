  ...
  return (
    <DocLayout>
      <div style={{ padding: '16px', 'max-width': '960px' }}>
        ...
        <DemoBlock title="最大 / 最小可选数" desc="max 限制最多可选数，min 限制最少可选数。" code={codeMaxMin}>
        ...
        <DemoBlock title="独立使用" desc="Checkbox 脱离 CheckboxGroup 单独使用，支持受控和非受控。" code={`<Checkbox value="x" label="非受控" defaultChecked />
