...
const checkboxProps: PropRow[] = [
  ...
  { name: 'label', type: 'string | JSX.Element', default: '—', required: false, desc: 'componentProps.checkbox.label' },
  { name: 'checked', type: 'boolean', default: '—', required: false, desc: 'componentProps.checkbox.checked' },
  { name: 'defaultChecked', type: 'boolean', default: 'false', required: false, desc: 'componentProps.checkbox.defaultChecked' },
  { name: 'indeterminate', type: 'boolean', default: 'false', required: false, desc: 'componentProps.checkbox.indeterminate' },
  { name: 'onChange', type: '(checked: boolean) => void', default: '—', required: false, desc: 'componentProps.checkbox.onChange' },
  { name: 'disabled', type: 'boolean', default: 'false', required: false, desc: 'componentProps.checkbox.disabled' },
  { name: 'labelDisabled', type: 'boolean', default: 'false', required: false, desc: 'componentProps.checkbox.labelDisabled' },
  { name: 'labelPosition', type: "'left' | 'right'", default: "'right'", required: false, desc: 'componentProps.checkbox.labelPosition' },
  { name: 'iconSize', type: 'number | string', default: "'20px'", required: false, desc: 'componentProps.checkbox.iconSize' },
  { name: 'checkedColor', type: 'string', default: "'#1989fa'", required: false, desc: 'componentProps.checkbox.checkedColor' },
  { name: 'shape', type: "'square' | 'round'", default: "'square'", required: false, desc: 'componentProps.checkbox.shape' },
  { name: 'checkedIcon', type: 'JSX.Element', default: '—', required: false, desc: 'componentProps.checkbox.checkedIcon' },
  { name: 'uncheckedIcon', type: 'JSX.Element', default: '—', required: false, desc: 'componentProps.checkbox.uncheckedIcon' },
  { name: 'indeterminateIcon', type: 'JSX.Element', default: '—', required: false, desc: 'componentProps.checkbox.indeterminateIcon' },
];

const groupProps: PropRow[] = [
  { name: 'value', type: 'unknown[]', default: '—', required: false, desc: 'componentProps.checkboxGroup.value' },
  ...
  { name: 'iconSize', type: 'number | string', default: "'20px'", required: false, desc: 'componentProps.checkboxGroup.iconSize' },
  { name: 'checkedColor', type: 'string', default: "'#1989fa'", required: false, desc: 'componentProps.checkboxGroup.checkedColor' },
  { name: 'shape', type: "'square' | 'round'", default: "'square'", required: false, desc: 'componentProps.checkboxGroup.shape' },
  { name: 'checkedIcon', type: 'JSX.Element', default: '—', required: false, desc: 'componentProps.checkboxGroup.checkedIcon' },
  { name: 'uncheckedIcon', type: 'JSX.Element', default: '—', required: false, desc: 'componentProps.checkboxGroup.uncheckedIcon' },
];
