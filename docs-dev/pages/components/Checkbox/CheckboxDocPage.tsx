...
const groupProps: PropRow[] = [
  { name: 'value', type: 'unknown[]', default: '—', required: false, desc: 'componentProps.Checkbox.value' },
  { name: 'defaultValue', type: 'unknown[]', default: '[]', required: false, desc: 'componentProps.Checkbox.defaultValue' },
  { name: 'onChange', type: '(values) => void', default: '—', required: false, desc: 'componentProps.Checkbox.onChange' },
  ...
  { name: 'max', type: 'number', default: '—', required: false, desc: 'componentProps.Checkbox.max' },
  { name: 'min', type: 'number', default: '—', required: false, desc: 'componentProps.Checkbox.min' },
