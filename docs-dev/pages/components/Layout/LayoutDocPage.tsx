...
export const LayoutDocPage = () => {
  ...
  <DocLayout>
    ...
    <div class={css.page}>
      ...
      <DemoBlock title={t('demo.layoutGrid')} desc={t('demoDesc.Layout_179f32')} code={'<Row>\n  <Col span={12}><div>12</div></Col>\n  <Col span={12}><div>12</div></Col>\n</Row>\n<Row>\n  <Col span={8}><div>8</div></Col>\n  <Col span={8}><div>8</div></Col>\n  <Col span={8}><div>8</div></Col>\n</Row>'}>
