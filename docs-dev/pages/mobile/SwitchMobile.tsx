      ...
      <div style={CARD.wrapper}>
        ...
        <div style={CARD.body}>
          <div style={{ display: 'flex' as const, 'align-items': 'center' as const, gap: '8px' }}>
            ...
            <span style={{ 'font-size': '0.85rem', color: '#374151' }}>受控: {val1() ? '开' : '关'}</span>
          </div>
          <div style={{ display: 'flex' as const, 'align-items': 'center' as const, gap: '8px' }}>
            <Switch defaultChecked />
            <span style={{ 'font-size': '0.85rem', color: '#374151' }}>默认开</span>
          </div>
          <div style={{ display: 'flex' as const, 'align-items': 'center' as const, gap: '8px' }}>
            <Switch checked={val2()} onChange={setVal2} />
            <span style={{ 'font-size': '0.85rem', color: '#374151' }}>默认关</span>
          </div>
        </div>
      </div>
      ...
      <div style={CARD.wrapper}>
        ...
        <div style={CARD.body}>
          <div style={{ display: 'flex' as const, 'align-items': 'center' as const, gap: '8px' }}>
            ...
            <span style={{ 'font-size': '0.85rem', color: '#374151' }}>绿色</span>
          </div>
          <div style={{ display: 'flex' as const, 'align-items': 'center' as const, gap: '8px' }}>
            <Switch defaultChecked activeText="开" inactiveText="关" />
            <span style={{ 'font-size': '0.85rem', color: '#374151' }}>带文字</span>
          </div>
        </div>
      </div>
      ...
      <div style={CARD.wrapper}>
        ...
        <div style={CARD.body}>
          <div style={{ display: 'flex' as const, 'align-items': 'center' as const, gap: '8px' }}>
            ...
            <span style={{ 'font-size': '0.85rem', color: '#374151' }}>20px</span>
          </div>
          <div style={{ display: 'flex' as const, 'align-items': 'center' as const, gap: '8px' }}>
            <Switch defaultChecked size={28} />
            <span style={{ 'font-size': '0.85rem', color: '#374151' }}>28px</span>
          </div>
          <div style={{ display: 'flex' as const, 'align-items': 'center' as const, gap: '8px' }}>
            <Switch defaultChecked size={36} />
            <span style={{ 'font-size': '0.85rem', color: '#374151' }}>36px</span>
          </div>
          <div style={{ display: 'flex' as const, 'align-items': 'center' as const, gap: '8px' }}>
            <Switch defaultChecked disabled />
            <span style={{ 'font-size': '0.85rem', color: '#9ca3af' }}>禁用</span>
          </div>
        </div>
      </div>
    </MobilePreview>
