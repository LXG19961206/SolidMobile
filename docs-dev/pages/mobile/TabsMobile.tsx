        ...
        <div style={CARD.body}>
          <Tabs active={active1()} onChange={setActive1}>
            <Tab name={0} title="标签 1">
              <div style={{ padding: '16px', color: '#374151' }}>内容 1</div>
            </Tab>
            <Tab name={1} title="标签 2">
              <div style={{ padding: '16px', color: '#374151' }}>内容 2</div>
            </Tab>
            <Tab name={2} title="标签 3">
              <div style={{ padding: '16px', color: '#374151' }}>内容 3</div>
            </Tab>
          </Tabs>
        </div>
      </div>
        ...
        <div style={CARD.body}>
          <Tabs type="card" active={active2()} onChange={setActive2}>
            <Tab name={0} title="选项 A">
              <div style={{ padding: '16px', color: '#374151' }}>卡片 A 内容</div>
            </Tab>
            <Tab name={1} title="选项 B">
              <div style={{ padding: '16px', color: '#374151' }}>卡片 B 内容</div>
            </Tab>
            <Tab name={2} title="选项 C">
              <div style={{ padding: '16px', color: '#374151' }}>卡片 C 内容</div>
            </Tab>
          </Tabs>
        </div>
      </div>
      ...
      <div style={CARD.wrapper}>
        ...
        <div style={CARD.body}>
          <Tabs active={active3()} onChange={setActive3} color="#22c55e" border>
            <Tab name="a" title="全部">
              <div style={{ padding: '16px', color: '#374151' }}>全部订单</div>
            </Tab>
            <Tab name="b" title="待付款">
              <div style={{ padding: '16px', color: '#374151' }}>待付款订单</div>
            </Tab>
            <Tab name="c" title="已完成">
              <div style={{ padding: '16px', color: '#374151' }}>已完成订单</div>
            </Tab>
          </Tabs>
        </div>
      </div>
