...
const propsData = [
  { name: 'TabBar.value', type: 'number | string', desc: '当前选中标签（受控）' },
  { name: 'TabBar.defaultValue', type: 'number | string', desc: '默认选中（非受控），默认 0' },
  { name: 'TabBar.onChange', type: '(name) => void', desc: '切换回调' },
  { name: 'TabBar.fixed', type: 'boolean', desc: '固定在底部，默认 true' },
  { name: 'TabBar.border', type: 'boolean', desc: '显示外边框，默认 true' },
  { name: 'TabBar.zIndex', type: 'number | string', desc: 'z-index，默认 1' },
  { name: 'TabBar.height', type: 'number | string', desc: '标签栏高度，默认 50px。占位高度同步' },
  { name: 'TabBar.activeColor', type: 'string', desc: '选中标签颜色，默认 #1989fa' },
  { name: 'TabBar.inactiveColor', type: 'string', desc: '未选中标签颜色，默认 #7d7e80' },
  { name: 'TabBar.safeArea', type: 'boolean', desc: '生成底部安全区域占位' },
  { name: 'TabBar.bgColor', type: 'string', desc: '自定义背景色，支持渐变、半透明' },
  { name: 'TabBar.placeholder', type: 'boolean', desc: 'fixed 时生成等高占位，防止遮挡内容' },
  { name: 'TabBar.beforeChange', type: '(name) => boolean | Promise', desc: '切换前回调，返回 false 阻止' },
  { name: 'TabBarItem.name', type: 'number | string', desc: '标签标识符（必填）' },
  { name: 'TabBarItem.icon', type: 'string | JSX.Element', desc: '图标名或自定义 JSX' },
  { name: 'TabBarItem.label', type: 'string', desc: '标签文字' },
  { name: 'TabBarItem.dot', type: 'boolean', desc: '图标右上角小红点' },
  { name: 'TabBarItem.badge', type: 'number | string', desc: '图标右上角徽标' },
];
