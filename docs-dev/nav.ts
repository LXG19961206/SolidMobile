...
export const GROUPS: MenuGroup[] = [
  {
    ...
    items: [
      ...
      { name: 'Card 卡片', key: 'card' }, { name: 'ScrollBar 滚动条', key: 'scrollbar' }, { name: 'Skeleton 骨架屏', key: 'skeleton' },
    ],
  },
  {
    title: 'Display 展示',
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Select 选择器', key: 'select' }, { name: 'TreeSelect 树选择', key: 'treeselect' }, { name: 'Upload 上传', key: 'upload' },
    ],
  },
];
