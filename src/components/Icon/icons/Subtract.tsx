export function Subtract(props: { size?: string | number; color?: string; class?: string; variant?: 'line' | 'fill'; }) {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={s()} height={s()}
      ...
      innerHTML={props.variant === 'fill' ? '<path d="M19 11H5V13H19V11Z"/>' : '<path d="M5 11V13H19V11H5Z"/>'} />
  );
}